...
class TestSortAsteroids(unittest.TestCase):
    ...
    def test_add(self):
        mock_asteroids = [
            ['(1998 HH49)', 'http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=3013045', 0.144, 0.322, 1697502780,
             '2023-10-17 00:33:00', '2023-10-17 00:33:00', 53232, 1173407, '3013045'],
            ['612856 (2004 TP1)', 'http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=2612856', 0.187, 0.419, 1697580180,
             '2023-10-17 22:03:00', '2023-10-17 22:03:00', 21803, 55066045, '2612856'],
            ['(2004 TP1)', 'http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=3255980', 0.193, 0.431, 1697580180,
             '2023-10-17 22:03:00', '2023-10-17 22:03:00', 21803, 33000000, '3255980'],
            ['(2023 JD6)', 'http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=54359256', 0.147, 0.328, 1697576640,
             '2023-10-17 21:04:00', '2023-10-17 21:04:00', 50500, 55909466, '54359256'],
            ['523585 (1998 MW5)', 'http://ssd.jpl.nasa.gov/sbdb.cgi?sstr=2523585', 0.441, 0.986, 1697548800,
             '2023-10-17 13:20:00', '2023-10-17 13:20:00', 23720, 30466533, '2523585'],
        ]
        # Expected result: asteroids sorted by passing distance in ascending order
        expected_result = sorted(mock_asteroids, key=lambda x: x[8])

        # Sort the mock asteroids
        sorted_asteroids = sort_ast_by_pass_dist(mock_asteroids)
        self.assertEqual(sorted_asteroids, expected_result)
